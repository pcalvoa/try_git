			...
			<fieldset>
				...
				<div style="position:relative;float:left;">
					<div id="userView" class="section inline" style="width:30px;margin:0 0 0 10px;">	
			    		<div class="legend mt-legend-text"><fmt:message key="page.user_title"/></div>
				...
				<input id="centerFormSubmit" class="submit" style="visibility: hidden;" type="submit" name="submit"/ />
			</fieldset>
		</form>				
...
<script id="tmplView" type="text/x-jquery-tmpl">	
			<div class="section">
		    	...
		    	<input readonly type="hidden" class="mt-input-text" id="<%=Fields.ID%>" name="<%=Fields.CENTER_ID%>"
					value="${id}" tabindex="1"/>
				<div style="margin-left:60px;">
					<label class="view mt-label-text" for="name"><fmt:message key="center.name"/> </label>
		    		<input readonly type="text" class="view mt-input-text" id="<%=Fields.CENTER_NAME%>_VIEW" name="<%=Fields.CENTER_NAME%>_VIEW" tabindex="1"
					value="${name}"/>
					<label class="edit mt-label-text" for="name"><fmt:message key="center.name"/>* </label>
					<input type="text" class="edit mt-input-text" id="<%=Fields.CENTER_NAME%>" name="<%=Fields.CENTER_NAME%>" tabindex="1"
					value="${name}"/>
				</div>
	    	</div>	

			<div id="description" class="section" style="float:left;width:300px;">
	    		<div class="legend mt-legend-text"><fmt:message key="center.description"/></div>
				<div class="separator micro" style="margin-left:40px;"></div>
				<div style="margin-left:60px;">
		    		<textarea readonly disabled rows="3" class="styletextarea view short mt-input-text" style="width:250;height:75px;" id="<%=Fields.CENTER_DESCRIPTION%>_VIEW" name="<%=Fields.CENTER_DESCRIPTION%>_VIEW" 
						tabindex="2">${description}</textarea>
		    		<textarea rows="3" class="styletextarea edit short mt-input-text" style="width:250;height:75px;" id="<%=Fields.CENTER_DESCRIPTION%>" name="<%=Fields.CENTER_DESCRIPTION%>" 
						tabindex="2">${description}</textarea>												
				</div>
				<div class="legend mt-legend-text"><fmt:message key="page.licenses_title"/></div>
				<div class="separator micro" style="margin-left:40px;"></div>
				<div style="margin-left:60px;">
					<input readonly type="text" class="view mt-input-text" id="<%=Fields.LICENSES%>_VIEW" name="<%=Fields.LICENSES%>_VIEW" tabindex="3"
					value="${licenses}"/>					
					<input type="text" class="edit mt-input-text" id="<%=Fields.LICENSES%>" name="<%=Fields.LICENSES%>" tabindex="3"
					value="${licenses}"/>
				</div>
	    	</div>		
