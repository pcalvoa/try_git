    ...
    // to reference this class from internal events and functions.
      ...
      // Top and tail the list with 'visible' number of items, top has the last section, and tail has the first
		...
		base.gotoPage = function(page, autoplay) {
			...
			// Desactivar el bucle
			// No permitir retroceder más allá de la primera
			var divId=base.$el.attr('id');
			if(divId!="slideTop") {
				//alert(base.currentPage+" - "+page);
				if(base.currentPage==2 && page==1) {
					var but=$("#"+divId+" #butBack");
					but.fadeOut(500);
					//return false;
				} else {
					var but=$("#"+divId+" #butBack");
				...
				// No permitir avanzar más alla de la última - las mostradas
				if(!autoplay && page>0) {
					if((page+4)>base.pages) {
						var but=$("#"+divId+" #butForward");
						but.fadeOut(500);
						//return false;
					} else {
						var but=$("#"+divId+" #butForward");
			...
			//$("#"+divId+" #butBack").removeClass('oculto');
			//$("#"+divId+" #butForward").removeClass('oculto');
		...
		base.buildNextBackButtons = function() {
			var $forward = $('<li class="arrow forward" id="butForward"><a href="#">' + base.options.forwardText + '</a></li>'),
			  	$back    = $('<li class="arrow back" id="butBack"><a href="#">' + base.options.backText + '</a></li>');
    ...
    // Bind to the forward and back buttons
      ...
      $forward.click(function(e) {
		...
		// Append elements to page
			...
			// Ocultar el botón back al inicio
			var divId=base.$el.attr('id');
			if(divId!="slideTop") {
				var but=$("#"+divId+" #butBack");
				but.hide();
